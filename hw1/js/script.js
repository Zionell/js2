...
const renderProduct = (item) => {
   ...
   return `<div class="product__card shadow filter-card trans">
               ...
               <a href="product.html" class="product-card__name">
                  ...
                  <p class="product-card__text">${item.descProduct}</p>
...
const renderProducts = () => {
   let productsRend = cardsProducts.map((item) => renderProduct(item));
   document.querySelector('.product__grid-wrap--catalog').innerHTML = productsRend.join("");
}
